...
/**
 * Creates an error message indicating that an assertion that verifies a group of elements contains a null element
...
public class ShouldContainNull extends BasicErrorMessageFactory {
  ...
  private ShouldContainNull(Object actual) {
    super("expecting:<%s> to contain a <null> element", actual);
  }
}
