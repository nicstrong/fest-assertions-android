...
/**
 * Creates an error message indicating that an assertion that verifies a group of elements does not contain null elements
 * failed. A group of elements can be a collection or an array.
 *
...
public class ShouldNotContainNull extends BasicErrorMessageFactory {
  ...
  private ShouldNotContainNull(Object actual) {
    super("expecting:<%s> not to contain <null> elements", actual);
  }
}
